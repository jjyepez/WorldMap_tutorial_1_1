const Locations = [
  ...
  ["CN", 35.86166, 104.195397, "Mainland China"],
  ...
  ["KR", 35.907757, 127.766922, "Korea South"],
  ...
  ["VI", 18.335765, -64.896335, "U.S. VirginIslands"],
...
function LocationByCountry({ country = "Colombia" }) {
  let data = Locations.filter(reg => reg[3] === country.trim());
  //console.log({ country, data });
  if (data.length > 0) {
    return [data[0][1], data[0][2]];
  }
  console.log({ country, msg: "not found" });
  return [0, 0];
}
